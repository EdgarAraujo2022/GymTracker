...
const create_workout_dto_1 = require("./dtos/create-workout.dto");
const update_workout_dto_1 = require("./dtos/update-workout.dto");
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], WorkoutsController.prototype, "findById", null);
