...
const bodymeasurements_controller_1 = require("./bodymeasurements.controller");
...
exports.BodyMeasurementsModule = BodyMeasurementsModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [bodymeasurements_controller_1.BodyMeasurementsController],
        providers: [bodymeasurements_service_1.BodyMeasurementsService],
    })
], BodyMeasurementsModule);
//# sourceMappingURL=bodymeasurements.module.js.map